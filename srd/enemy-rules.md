...
1.	**Blast**: Enemy takes a turn to “wind up” and then, on its next turn, deals X damage to up to X nearby targets. Example: Dragon. 32 HP, claws (2x3) or fire breath (6 Blast).
2.	**Drain**: Target takes X damage and gains 0 XP this session or, if Level 4, must retire. Example: Ghost. 8 HP, touch (2 Drain).
3.	**Stun**: Target takes X damage +1 damage for each move or action they take next turn. Example: Ghoul. 6 HP, claws (2 Stun).